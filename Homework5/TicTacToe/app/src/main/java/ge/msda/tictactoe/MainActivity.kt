...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private var firsplayerscore:Int=0
    ...
    private fun scores(firstscore:Int,secondscore:Int) {

        playerx.text = "X:" + firstscore.toString()
        playero.text = "O:"+secondscore.toString()
    ...
    private fun check() {
        ...
        if (winnerPlayer != 0) {
            if (winnerPlayer == 1) {
                ...
                firsplayerscore+=1
                scores(firsplayerscore,secondplayerscore)
